...
```{r ggplot Syntax}
ggplot(aes(x=age,y=friend_count),data=pf) + geom_point(binwidth=1) + xlim(13,90)
...
Also users less than the age of 25 have more friends compared to other aged groups.
